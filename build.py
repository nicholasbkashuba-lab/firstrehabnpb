...
EPISODES = [
    ("Episode 7", "Dr. Rami Elkechen, MD", "Dr. Rami Elkechen, MD, joins Dave and Mike for a new episode of Pain 2 Power. Press play above for the full conversation — and if a question comes to mind, send it our way through the new Ask Dave form below.", "https://open.spotify.com/episode/1cVdymVweFWtoIRropqKQ7", "Listen"),
